// Based on script from https://www.habrador.com/tutorials/interpolation/1-catmull-rom-splines/

using System.Collections;
using System.Collections.Generic;
using UnityEngine;

public class CatmullRomLine : MonoBehaviour
{
	...
	void DisplayCatmullRomSpline(int pos)
	{
		...
		//line.positionCount = loops + 1;

		//line.SetPosition(0, lastPos);
		if (!linePoints.Contains(lastPos))
		{
